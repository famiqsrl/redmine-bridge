...
namespace Famiq\RedmineBridge\Symfony\DependencyInjection;
...
use Famiq\RedmineBridge\Symfony\RedmineBridgeCheckCommand;
use Famiq\RedmineBridge\Symfony\SymfonyIdempotencyStore;
...
final class RedmineBridgeExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->register(RedmineClienteService::class)
            ->setArguments([
                new Reference(ContactResolverInterface::class),
                new Reference('logger'),
            ]);

        $container->register(RedmineTicketService::class)
            ->setArguments([
                new Reference(RedmineHttpClient::class),
                new Reference(RedmineConfig::class),
